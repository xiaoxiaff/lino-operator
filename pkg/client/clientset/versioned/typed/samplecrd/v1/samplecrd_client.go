...
import (
	...
	"github.com/lino-network/lino-operator/pkg/client/clientset/versioned/scheme"
...
func (c *SamplecrdV1Client) Fullnodes(namespace string) FullnodeInterface {
	return newFullnodes(c, namespace)
}
